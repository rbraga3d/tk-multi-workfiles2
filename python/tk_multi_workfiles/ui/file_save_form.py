...
"}")
        ...
        self.lock_edit_name_cb = QtGui.QCheckBox(FileSaveForm)
        self.lock_edit_name_cb.setText("Lock Edit Name")
        self.lock_edit_name_cb.setObjectName(u"lock_edit_name_cb")
        self.lock_edit_name_cb.setEnabled(True)
        sizePolicy1 = QtGui.QSizePolicy(QtGui.QSizePolicy.Policy.Minimum, QtGui.QSizePolicy.Policy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.lock_edit_name_cb.sizePolicy().hasHeightForWidth())
        self.lock_edit_name_cb.setSizePolicy(sizePolicy1)
        self.lock_edit_name_cb.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.lock_edit_name_cb.setChecked(True)
        self.horizontalLayout_8.addWidget(self.lock_edit_name_cb)
        ...
        self.lock_edit_name_cb.toggled.connect(self.name_edit.setDisabled)
